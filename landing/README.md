...
> Stap 1 (dubbelklikken op ZIP) heeft geen screenshot nodig — die actie is voor leerlingen self-explanatory.
...
1. **step-2-edge-extensions.png** — Edge geopend op `edge://extensions/` (lege staat, geen extensies geladen, of met andere extensies). Toon vooral de URL-balk + linker zijbalk.
2. **step-3-dev-mode.png** — Close-up van de **Ontwikkelaarsmodus**-toggle linksonder, in AAN-stand. Liefst met een rode cirkel/pijl rondom.
3. **step-4-drag-folder.png** — Twee opties: (a) drag-en-drop animatie waarbij een mapje vanuit Verkenner over de Edge-pagina zweeft, of (b) close-up van de **"Uitgepakte versie laden"** knop bovenaan met markering.
4. **step-5-pin.png** — Edge toolbar met het puzzelstukje opengeklapt en het Safe AI Way-icoon met pin-knop, of het icoon uiteindelijk vastgepind aan de toolbar.
